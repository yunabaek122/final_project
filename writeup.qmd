...
::: {.columns}
![HEI](pictures/HEI.png){width=25%}
![HSI](pictures/HSI.png){width=25%}
![lowincome](pictures/lowincome.png){width=25%}
![poc](pictures/poc.png){width=25%}
:::
...
::: {.columns}
![asthma](pictures/asthma.png){width=40%}
